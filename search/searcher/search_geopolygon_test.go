...
func TestRealGeoPolygons(t *testing.T) {
	...
	tests := []struct {
		...
		{
			[]geo.Point{
				{Lon: -80.881, Lat: 35.282}, {Lon: -80.858, Lat: 35.281},
				{Lon: -80.864, Lat: 35.270},
			}, "loc", []string{"k", "l"},
		},
		{
			[]geo.Point{
				{Lon: -82.467, Lat: 36.356}, {Lon: -78.127, Lat: 36.321}, {Lon: -80.555, Lat: 32.932},
		...
		{
			[]geo.Point{
				{Lon: -82.467, Lat: 36.356}, {Lon: -82.467, Lat: 36.356}, {Lon: -82.467, Lat: 36.356},
				{Lon: -82.467, Lat: 36.356},
			}, "loc", nil,
		},
		// non-overlaping polygon
		{
			[]geo.Point{{Lon: -89.113, Lat: 36.400}, {Lon: -93.947, Lat: 36.471}, {Lon: -93.947, Lat: 34.031}}, "loc",
			nil,
		},
		// concave polygon with a document `n` residing inside the hands, but outside the polygon
		{
			[]geo.Point{
				{Lon: -71.65, Lat: 42.446}, {Lon: -71.649, Lat: 42.428}, {Lon: -71.640, Lat: 42.445},
				{Lon: -71.649, Lat: 42.435},
			}, "loc", nil,
		},
		// V like concave polygon with a document 'p' residing inside the bottom corner
		{
			[]geo.Point{
				{Lon: -80.304, Lat: 40.740}, {Lon: -80.038, Lat: 40.239}, {Lon: -79.562, Lat: 40.786},
				{Lon: -80.018, Lat: 40.328},
			}, "loc", []string{"p"},
		},
		{
			[]geo.Point{
				{Lon: -111.918, Lat: 33.515}, {Lon: -111.938, Lat: 33.494}, {Lon: -111.944, Lat: 33.481},
				{Lon: -111.886, Lat: 33.517},
				{Lon: -111.919, Lat: 33.468}, {Lon: -111.929, Lat: 33.508},
			}, "loc", []string{"q"},
		},
		// real points near cb bangalore
		{
			[]geo.Point{
				{Lat: 12.974872, Lon: 77.607749}, {Lat: 12.971725, Lon: 77.610110},
...
func TestComplexGeoPolygons(t *testing.T) {
	...
	tests := []struct {
		...
		*/
		...
		{
			[]geo.Point{
				{Lon: 6.0, Lat: 2.0}, {Lon: 3.0, Lat: 4.0}, {Lon: 9.0, Lat: 6.0},
				{Lon: 3.0, Lat: 8.0}, {Lon: 6.0, Lat: 10.0}, {Lon: 6.0, Lat: 2.0},
			},
			[]geoPoint{
				{title: "a", lon: 3, lat: 4}, {title: "b", lon: 7, lat: 6}, {title: "c", lon: 4, lat: 8.1},
		...
		*/
		{
			[]geo.Point{
				{Lon: 7.0, Lat: 2.0}, {Lon: 1.0, Lat: 8.0}, {Lon: 1.0, Lat: 2.0},
				{Lon: 7.0, Lat: 8.0}, {Lon: 7.0, Lat: 2.0},
			},
			[]geoPoint{
				{title: "a", lon: 6, lat: 5}, {title: "b", lon: 5, lat: 5}, {title: "c", lon: 3, lat: 5.0},
